...
function publicConfig() {
  return { appName: config.appName, nodeEnv: config.nodeEnv, mode: 'deterministic-web-search', firebaseConfigured: Boolean(config.firebase.projectId && config.firebase.clientEmail && config.firebase.privateKey), memoryEncryption: true };
}
